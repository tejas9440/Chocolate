...
export default function MyCart(props) {
    ...
    const makePayment = async (email) => {
        ...
        const response = await fetch('https://chocolate-vert.vercel.app/create-checkout-session', {
            method: "post",
            headers: headers,
    ...
    const handleIncrement = async (productId, index) => {
        const userId = localStorage.getItem('userId')
        try {
            let response = await fetch(`https://chocolate-vert.vercel.app/quantity`, {
                method: 'POST',
    ...
    const handleDecrement = async (productId, index) => {
        const userId = localStorage.getItem('userId')
        try {
            const response = await axios.post('https://chocolate-vert.vercel.app/quantity', {
                userId,
                productId,
                action: 'dec',
            });
    ...
    const handleRemove = async (productId, index) => {
        const userId = localStorage.getItem('userId')
        try {
            await axios.post('https://chocolate-vert.vercel.app/remove-from-cart', {
                userId,
                productId,
            });
